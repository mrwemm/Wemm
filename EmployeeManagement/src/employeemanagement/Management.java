...
public class Management {
    ...
    public void createDumData() {
        Administration newadmin = new Administration("Paul", "x@x.com", "male", "02-12-1200", 100, "a");
        Administration newadmin2 = new Administration("Paulz", "z@x.com", "male", "02-12-1200", 200, "b");
        Administration newadmin3 = new Administration("Paulz", "y@x.com", "male", "02-12-1200", 300, "c");
        Administration newadmin4 = new Administration("Paulzz", "w@x.com", "male", "02-12-1200", 400, "d");
        ...
        Programmers prog = new Programmers("Robert", "l@x.com", "male", "02-12-1200", 500, "f");
        addToArray(prog);
        Technicians newadmin7 = new Technicians("Sara", "l@x.com", "female", "02-12-1200", 500, "g");
        addToArray(newadmin7);
    }
    ...
    private void printAllEmployee() {
        String format = "%1$-8s|%2$-20s|%3$-20s|%4$-20s|%5$-20s|%6$-20s|%7$-20s\n";
        System.out.format(format, "ID", "Name", "Email", "Birthdate", "Gender", "Salary", "Bonus");
        //System.out.println("ID\tName\tEmail\tBirthdate\tGender\tSalary");
        for (Employee employee : employeeList) {
            System.out.format(format, employee.getId(), employee.getName(), employee.getEmail(), employee.getDateOfBirth(), employee.getGender(), employee.getSalary(), employee.calcBonus());
